---
file: skills/__SKILL_NAME__/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for __SKILL_NAME__ so it stays stable under iteration.
---

# __SKILL_NAME__: Maintainer README
