---
file: skills/milestone-bill/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for milestone-bill so it stays stable under iteration.
---

# milestone-bill: Maintainer README
