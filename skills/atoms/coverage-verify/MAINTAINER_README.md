---
file: skills/coverage-verify/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for coverage-verify so it stays stable under iteration.
---

# coverage-verify: Maintainer README
