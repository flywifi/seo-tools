---
file: skills/task-plan/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for task-plan so it stays stable under iteration.
---

# task-plan: Maintainer README
