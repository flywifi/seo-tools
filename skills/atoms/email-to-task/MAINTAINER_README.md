---
file: skills/email-to-task/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for email-to-task so it stays stable under iteration.
---

# email-to-task: Maintainer README
