---
file: skills/task-extract/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for task-extract so it stays stable under iteration.
---

# task-extract: Maintainer README
