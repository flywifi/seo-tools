...
purpose: keep benchmark-compare honest about data source; benchmark ranges are industry estimates, never the creator's personal data.
---

# benchmark-compare: Maintainer README

## Purpose
Compare a metric against industry benchmark ranges from canonical-sources/rate-benchmarks/benchmarks.json. Always labels sources; never presents a benchmark as the creator's personal data.
...
## Known failure modes
- Presenting a benchmark CTR range as "the creator's typical CTR."
