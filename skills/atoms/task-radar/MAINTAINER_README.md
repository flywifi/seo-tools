---
file: skills/task-radar/MAINTAINER_README.md
purpose: preserve the non-negotiable operating rules for task-radar so it stays stable under iteration.
---

# task-radar: Maintainer README
