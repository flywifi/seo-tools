...
- **Python 3.12 to 3.14.** The built-in `/usr/bin/python3` is a non-working stub. User-only
  route (P93, docs/INSTALL-SCOPE.md): the uv installer into `~/.local`. Machine-wide
