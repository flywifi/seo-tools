...
description: Read-only vendor and product price research for Creator OS cost estimates and proposals. Returns JSON with the verification envelope; use it through the Creator OS workflows.
