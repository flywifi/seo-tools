...
`.venv` built on the mcp 1.x SDK keeps working on the documented loopback deployment (the server starts on either major; a non-loopback bind under 1.x is also handled since P81); to move it to 2.x,
