---
file: shared/audience-engine.md
role: Source of truth for who the audience is and how they behave. Read by the hub and by
  content, analytics, and CRM brand-fit skills. Brand identity and voice live in
  shared/brand-engine.md; platform mechanics live in shared/platform-engine.md.
load: when the request involves audience, personas, targeting, analytics interpretation, or brand fit
---
...
## Behavior signals (how to read engagement)
- Saves: reference and depth value. High saves mean tutorials, checklists, and decor inspo worth
  returning to. Strongest signal for evergreen and Pinterest-friendly topics.
- Shares: spreadability and relatability. High shares mean the piece is surprising, pretty, or
  emotionally resonant.
- Comments: emotional resonance and conversation. Mine them for repeated questions and pain points
  (feeds the audience-research and content-strategy spokes).
- Follows or subscribes from a piece: growth power.
- Completion rate and retention: hook and pacing health (interpreted against platform-engine).

## Content roles (design a healthy mix)
- Growth content: optimized for reach and new-viewer discovery (often short-form, high shareability).
- Depth and trust content: optimized for saves and watch time (tutorials, full builds).
- Community content: optimized for comments and connection (behind the scenes, Q and A, stories).

## Social listening (qualitative)
Treat comments and DMs as data. Convert repeated questions into FAQs and dedicated pieces, repeated
pain points into project ideas that solve them, and popular requests into calendar priorities.
